...
public class ClienteController implements Serializable {
    ...
    @EJB
    private com.gas.ClienteFacade ejbFacade;
    ...
    public List<Cliente> completeText(String query) {
        ...
        List<Cliente> lest = ejbFacade.findByActivos(query);
        ...
        FacesContext.getCurrentInstance().getExternalContext().redirect("../cliente/"+url+".xhtml");
        return "ok";
    }
